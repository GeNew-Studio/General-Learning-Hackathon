const DEMO_SCRIPTS = {
  elder: {
    ...
    name: "Chen Shufen",
    role: "Retired elder",
    hint: "Family-emergency lure — close wording is enough.",
    turns: [
      {
        scammer: "Grandpa it's me!! I dropped my phone on the street 😭 this is my new number",
        victim: "John?? Oh dear, are you alright? You sound different on text",
      },
      {
        scammer:
          "I'm in trouble… I borrowed a friend's camera drone and flew it straight into someone's car 😭 now he wants HK$58,000 to replace it today or he's calling the police 🙏 Please don't tell dad",
        victim: "Oh no. Of course grandpa will help. How do I send it to you?",
      },
      {
        scammer:
          "Transfer to my friend's account, he'll pass it to me:\nHSBC 202-932026-202 M.J. Chan",
        victim: "Ok give me a minute",
      },
      {
        scammer:
          "You're the best grandpa!! Don't tell dad — I'll explain everything when I'm home tonight 🙏",
        victim: "Okay I have transferred the money, John and I won't tell your father. Come home soon",
      },
    ],
  },
  job_seeker: {
    ...
    name: "Wei Na",
    role: "Job seeker",
    hint: "Task / remote-job lure — close wording is enough.",
    turns: [
      {
        scammer:
          "Hi David HK remote position — rate hotel listings online, HK$1000 a day, totally flexible 😊",
        victim: "I just got laid off, so yes please. What's the work?",
      },
      {
        scammer:
          "Super easy — register here and finish your first 5 tasks:\nearnn0w.xyz/invite/D88",
        victim: "Okay, clicking away… oh! It says I earned HK$150 already. That's real money?",
      },
      {
        scammer:
          "Yes! To unlock VIP tier with bigger commissions, top up your deposit:\nHSBC 123-456789-012 Golden Task Ltd",
        victim: "Paying to work feels odd… but the first payout did arrive How much will I be earning?",
      },
      {
        scammer: "HK$5,000 — you earn it back in two days, guaranteed 💰",
        victim: "Alright, transferring now. thank youuuu",
      },
    ],
  },
  crypto: {
    ...
    hint: "Airdrop / wallet-connect lure — close wording is enough.",
    turns: [
      {
        scammer: "Polly, your wallet qualified for the BRIA airdrop — 3,000 tokens have been reserved for you",
        victim: "Finally! I've been waiting for so long. How do I claim?",
      },
      {
        scammer:
          "Verify your wallet with a small gas fee — send 90 USDT here: 0x8fA3d5E8a1B3gB71cD8d6Eg1F52d",
        victim: "Before I send anything — is there an official claim page? I got burned last year so I want to be careful",
      },
      {
        scammer: "Of course, the official portal is here:\nbria-claim.io/airdrop",
        victim: "Looks good Sending the gas fee now",
      },
    ],
  },
  student: {
    ...
    hint: "公检法 / 入境调查 lure — close wording is enough.",
    turns: [
      {
        scammer:
          "《入境事务处》你涉及内地／境外刑事案件、非法入境或黑工，需要配合调查。",
        victim: "什么？",
      },
      {
        scammer:
          "我是陈小明（警号: 12345678)。你涉及内地非法入境，需要配合调查。要求提供香港身份证号码、银行账户密码、网银验证码或缴交保证金至指定安全账户。(HSBC 930-202645-593)",
        victim:
          "好的\n身份证：Y123456(7)\n银行账户密码: abc123098zyx\n网银验证码：454545\n要缴交多少？",
      },
      {
        scammer: "2000000港元",
        victim: "好的转了，那我现在还要做什么吗？",
      },
    ],
  },
  dating: {
